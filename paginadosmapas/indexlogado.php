...
<html lang="pt-br">
  ...
  <aside>
    ...
    <button class="close-acre">fechar</button>
    </dialog>
    ...
    <dialog class="modal-alagoas">
      ...
      <button class="close-alagoas">fechar</button>
    </dialog>
    ...
    <dialog class="modal-amapa">
      ...
      <button class="close-amapa">fechar</button>
    </dialog>
    ...
    <dialog class="modal-amazonas">
      ...
      <button class="close-amazonas">fechar</button>
    </dialog>
    ...
    <dialog class="modal-bahia">
      ...
      <button class="close-bahia">fechar</button>
    </dialog>
    ...
    <dialog class="modal-ceara">
      ...
      <button class="close-ceara">fechar</button>
    </dialog>
    ...
    <dialog class="modal-df">
      ...
      <button class="close-df">fechar</button>
    </dialog>
    ...
    <dialog class="modal-es">
      ...
      <button class="close-es">fechar</button>
    </dialog>
    ...
    <dialog class="modal-goias">
      ...
      <button class="close-goias">fechar</button>
    </dialog>
    ...
    <dialog class="modal-maranhao">
      ...
      <button class="close-maranhao">fechar</button>
    </dialog>
    ...
    <dialog class="modal-matogrosso">
      ...
      <button class="close-matogrosso">fechar</button>
    </dialog>
    ...
    <dialog class="modal-mgs">
      ...
      <button class="close-mgs">fechar</button>
    </dialog>
    ...
    <button class="close-minas">fechar</button>
    </dialog>
    ...
    <dialog class="modal-para">
      ...
      <button class="close-para">fechar</button>
    </dialog>
    ...
    <dialog class="modal-parana">
      ...
      <button class="close-parana">fechar</button>
    </dialog>
    ...
    <dialog class="modal-pernambuco">
      ...
      <button class="close-pernambuco">fechar</button>
    </dialog>
    ...
    <button class="close-paraiba">fechar</button>
    </dialog>
    ...
    <button class="close-piaui">fechar</button>
    </dialog>
    ...
    <dialog class="modal-rj">
      ...
      <button class="close-rj">fechar</button>
    </dialog>
    ...
    <!-- Rio Grande do Norte -->
      ...
      <dialog class="modal-rgn">
        ...
        <button class="close-rgn">fechar</button>
      </dialog>
    ...
    <dialog class="modal-rs">
      ...
      <button class="close-rs">fechar</button>
    </dialog>
    ...
    <button class="close-rd">fechar</button>
    </dialog>
    ...
    <dialog class="modal-rm">
      ...
      <button class="close-rm">fecha</button>
    </dialog>
    ...
    <dialog class="modal-sc">
      ...
      <button class="close-sc">fechar</button>
    </dialog>
    ...
    <button class="close-sp">fechar</button>
    </dialog>
    ...
    <dialog class="modal-sergipe">
      ...
      <button class="close-sergipe">fechar</button>
    </dialog>
    ...
    <dialog class="modal-to">
      ...
      <button class="close-to">fechar</button>
    </dialog>

  </aside>

  <main>
    <div class="mapa-completo"><iframe src="https://www.google.com/maps/d/u/0/embed?mid=1iy6AOtDHCmUthOt3m-9qcfSkLNzYRb4&ehbc=2E312F&noprof=1" width="640" height="480"></iframe></div>
  </main>
