...
<body>
                 ...
                 <?php foreach ($organizacoes as $organizacao): ?>
                    <div class="swiper-slide">
                        <div class="horta-item">
                            <img src="assets/icon-perfil.png" alt="Ícone de perfil cinza" class="icon-perfil">
    ...
    <section class="cadastro" id="link-cadastro">
        ...
        <a class="botao-cadastro" href="../html/cadastrocolaborador.php">Colaborador</a>
        </div>   

        <div class="organizacao_">
        <h1 class="cads">Cadastre a sua ONG</h1>
        <a class="botao-cadastro" href="../html/cadastroorganizacao.php">Cadastrar</a>
        </div>   
