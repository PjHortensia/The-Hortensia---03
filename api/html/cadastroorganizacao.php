...
<head>
    ...
    <link rel="stylesheet" href="../pghome">
...
<body>
    ...
    <section class="cadastrocolaborador">
        ...
        <div class="formulariocadastrocolaborador">
            ...
            <form action="../html/cadastrarorg.php" method="post">
                <br><br>
            
                <div id="etapa1" onclick="etapaChange1()" class="insideform">
                    <div class="titleform">
                        <h1>Cadastro para <span class="bolder">organizações</span></h1>
                    ...
                    <div class="pinputs">
                        ...
                        <input type="text" placeholder="Usuário do instagram" name="userinsta">
                ...
                <div id="etapa2" onclick="etapaChange2()" class="insideform">
                    ...
                    <button type="submit" class="continuarbtn" id="finalizar">Finalizar Cadastro</button>
